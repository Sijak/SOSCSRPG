    ...
    internal static class WorldFactory
    {
        ...
        internal static World CreateWorld()
        {
            ...
            if (File.Exists(GAME_DATA_FILENAME))
            {
                ...
                LoadLocationsFromNode(world, rootImagePath, data.SelectNodes("./Locations/Location"));
            }
            else
            {
        ...
        private static void LoadLocationsFromNode (World world, string rootImagePath, XmlNodeList nodes)
        {
            if (nodes ==null)
            {
                return;
            ...
            {
                Location location = new Location(node.AttributeAsInt("X"), node.AttributeAsInt("Y"),
